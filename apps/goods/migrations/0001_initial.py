    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_new', models.BooleanField(default='', verbose_name='是否新品')),
                ('is_hot', models.BooleanField(default='', verbose_name='是否热销')),
                ('add_time', models.DateTimeField(default=datetime.datetime(2019, 7, 8, 16, 37, 47, 627050), verbose_name='添加时间')),
            ],
        ),
        migrations.CreateModel(
